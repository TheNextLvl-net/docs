...
<Callout type="info">
  Worlds has officially supported Folia since version 2.1.0 (Minecraft 1.21.4).
  Some limitations exist with nether portal linking on Folia, but end portals work perfectly.
</Callout>
...
Presets can define world type, dimension, structures, and even flat world layer configurations.
