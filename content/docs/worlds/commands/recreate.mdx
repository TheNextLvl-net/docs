...
**Usage:** `/world recreate <world> <name> [options...]`

**Permission:** `worlds.command.recreate`
...
The same options as in [`/world create`](create#additional-options) apply: `bonus-chest`, `seed`, `structures`, `hardcore`, and `dimension`.  
